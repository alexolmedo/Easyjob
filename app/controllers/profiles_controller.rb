class ProfilesController < ApplicationController
    ...
    private
      ...
      def profile_params
        params.require(:profile).permit(:first_name, :last_name, :avatar, :job_title, :phone_number, :contact_email, :facultad, :carrera, :semestre, :habilidades, :idiomas, :ubicacion) 
      end
